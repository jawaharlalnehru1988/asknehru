  ...
  typescriptTopics: TsTopics[] = [
    ...
    {title: 'Array and Object Methods in Typescript',
      subtopics: [
        ...
        {id: 82, name: 'Async methods'},
        {id: 83, name: 'Async/await methods'},
        {id: 84, name: 'Async generators methods'},
        {id: 85, name: 'Async/await generators methods'},
        {id: 86, name: 'Async iterators methods'},
        {id: 87, name: 'Async/await iterators methods'},
