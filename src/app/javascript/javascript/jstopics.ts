...
export class Jstopics{
      ...
      categorisedTopics: JsModel[] = [
        ...
        {title: "Functions", topics: [
            ...
            {id: 6, subTopic: "Function Overriding"},
            {id: 7, subTopic: "Function Binding"},
            {id: 8, subTopic: "Function Closures"},
            {id: 9, subTopic: "Function Currying"},
            {id: 10, subTopic: "Function Partial Application"},
            {id: 11, subTopic: "Function Memoization"},
            {id: 12, subTopic: "Function Composition"},
            {id: 13, subTopic: "Function Throttling"},
            {id: 14, subTopic: "Function Debouncing"},
            {id: 15, subTopic: "Function Pipeline"},
            {id: 16, subTopic: "Function Recursion"},
            {id: 17, subTopic: "Function Generators"},
            {id: 18, subTopic: "Function Async"},
        ]},
        {
            title: "Arrays", topics: [
